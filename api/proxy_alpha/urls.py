...
from proxy_alpha.controllers import authcon
from proxy_alpha.controllers import container
...
urlpatterns = [
  ...
  # Remove Proxy Config
  path('container/remove_proxy_config', container.configure_remove_proxy),
